...
CGO_ENABLED=0 GOOS=linux GOARCH=amd64 go build -ldflags "-s -w" -trimpath -o ./cvemonitor_linux_x64 ./main.go
echo "build macos arm64 cvemonitor..."
CGO_ENABLED=0 GOOS=darwin GOARCH=arm64 go build -ldflags "-s -w" -trimpath -o ./cvemonitor_macos_arm64 ./main.go
